...
import { GroupForm, useDepartmentMutations, useDepartmentQuery } from '@/entities/groups'
...
export const Departments: React.FC = () => {
  ...
  return (
    <div className={styles['page-wrapper']}>
      <Header
        title="Группы"
        actions={<Button onClick={() => setIsCreateNewFormVisible(!isCreateNewFormVisible)}>Создать группу</Button>}
      ></Header>
